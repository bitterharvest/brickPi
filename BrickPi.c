...
int BrickPiSetup(){
	...
	uart0_filestream = open("/dev/ttyAMA0", O_RDWR | O_NOCTTY | O_NDELAY);	
          printf("UART_file_descriptor:%d", UART_file_descriptor ); 
